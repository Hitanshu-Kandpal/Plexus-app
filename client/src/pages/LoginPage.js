...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const REDIRECT_URI = process.env.NODE_ENV === 'production' ? `${window.location.origin}/auth/callback` : (process.env.REACT_APP_REDIRECT_URI || 'http://localhost:3000/auth/callback');
